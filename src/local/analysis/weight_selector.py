...
class WeightSelector:
    ...
    def _calculate_selection_scores(
        self, data: pd.DataFrame, target_date: datetime
    ) -> pd.DataFrame:
    ...
    def _create_weight_record(
        self, measurement: pd.Series, target_date: datetime, prefer_filtered: bool
    ) -> Dict:
    ...
    def select_baseline_weight(
        self, measurements: pd.DataFrame, sources: List[str] = None
    ) -> Optional[Dict]:
        """
    ...
    def calculate_weight_change(
        self, initial_weight: Optional[float], current_weight: Optional[float]
    ) -> Dict:
        """
    ...
    def identify_data_gaps(
        self, measurements: pd.DataFrame, expected_frequency_days: int = 7
    ) -> List[Dict]:
        """
