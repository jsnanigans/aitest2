...
def test_imports():
    ...
    imports_to_test = [
        ...
        ("Quality Scorer", "from src.core.processing.unified_quality_scorer import UnifiedQualityScorer"),
        ("Outlier Detection", "from src.core.processing.outlier_detection import OutlierDetector"),
        ("Validation", "from src.core.processing.validation import DataQualityPreprocessor"),

        # Database modules
        ("Database Base", "from src.core.database.base import StateStore"),
        ("Database", "from src.core.database import get_state_db"),
        ("DynamoDB Store", "from src.core.database.dynamodb_store import DynamoDBStateStore"),
        ...
        ("Weight Processor Service", "from src.aws.services.weight_processor_service import WeightProcessorService"),
