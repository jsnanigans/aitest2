...
def main():
    ...
    overall_results = {
        ...
        "processing_mode": "two_phase_manual",
        "individual_processing": None,
        "replay_processing": None
    }

    # Two-phase mode: Individual processing + Manual replay
    print("\n=== Two-Phase Processing (Manual Replay) ===")
    ...
    # Manual replay batch processing
    ...
    if overall_results["replay_processing"]:
        ...
        print(f"Manual replay processing: {successful_replays:,}/{len(replay_stats):,} successful")
