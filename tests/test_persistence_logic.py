...
class TestPersistenceValidator:
    ...
    def test_validate_state_with_valid_state(self):
        ...
        is_valid, error = PersistenceValidator.validate_state(state, "user123", "test")
...
class TestProcessorPersistence:
    ...
    def setup_mocks(self):
        ...
        with (
            patch("src.processing.processor.get_state_db") as mock_db_factory,
    ...
    def test_persistence_after_successful_processing(self, setup_mocks):
        ...
        config = {
            ...
            "quality_scoring": {"use_quality_override": False},
        }
    ...
    def test_no_persistence_for_invalid_state(self, setup_mocks):
        ...
        failure_logged = any(call[0][1] == "validate_failed" for call in audit_calls)
    ...
    def test_rejected_measurements_not_persisted(self):
        ...
        with (
            ...
            config = {
                "feature_manager": mock_fm,
                "kalman": {},
                "processing": {"outlier_detection": {"enabled": True}},
            }
