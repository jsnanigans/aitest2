...
class MeasurementResult(BaseModel):
    ...
    measurement_id: str
    accepted: bool
    value: float = Field(description="Original weight value")
    unit: str = Field(description="Unit of measurement (kg/lbs)")
    effective_date_time: datetime = Field(description="When the measurement was taken")
    source_type: Optional[str] = Field(None, description="Source type of the measurement")
