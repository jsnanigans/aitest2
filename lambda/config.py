...
def load_config() -> Dict[str, Any]:
    ...
    config = {
        "kalman": {
            ...
            "adaptation_enabled": os.getenv("KALMAN_ADAPTATION_ENABLED", "true").lower() == "true",
        ...
        "quality_scoring": {
            ...
            "component_weights": {
                ...
                "physiological_plausibility": float(os.getenv("QS_WEIGHT_PHYSIO", "0.15")),
                "statistical_position": float(os.getenv("QS_WEIGHT_STATISTICAL", "0.10")),
                "measurement_frequency": float(os.getenv("QS_WEIGHT_FREQUENCY", "0.10")),
            },
            "thresholds": {
                "high_quality": float(os.getenv("QS_THRESHOLD_HIGH", "0.8")),
                "medium_quality": float(os.getenv("QS_THRESHOLD_MEDIUM", "0.5")),
                "outlier_override": float(os.getenv("QS_THRESHOLD_OUTLIER_OVERRIDE", "0.85")),
            },
        },
        "processing": {
            "extreme_threshold": float(os.getenv("PROCESSING_EXTREME_THRESHOLD", "0.15")),
            "max_daily_change_kg": float(os.getenv("PROCESSING_MAX_DAILY_CHANGE", "2.0")),
        ...
        "replay": {
            ...
            "outlier_detection": {
                "methods": json.loads(os.getenv("REPLAY_OUTLIER_METHODS", '["iqr", "mad"]')),
            ...
            "safety": {
                ...
                "rollback_on_error": os.getenv("REPLAY_ROLLBACK_ON_ERROR", "true").lower() == "true",
            },
        },
        "circuit_breaker": {
